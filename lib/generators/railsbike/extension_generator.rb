  ...
  module Generators
    class ExtensionGenerator < Rails::Generators::NamedBase
      ...
      def create_app_dirs
        ...
        empty_directory extension_dir('app/assets')
        empty_directory extension_dir('app/assets/images')
        empty_directory extension_dir('app/assets/javascripts')
        empty_directory extension_dir('app/assets/stylesheets')
      end
